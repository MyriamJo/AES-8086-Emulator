...
mov SI,0  ; indexing the row nb of muduolo
mov BP,0  ; indexing row in each column of input & indexing the column in moduolo row
mov DI,0  ; indexing nb of column input
L5: mov AX,4
mul BP
add AX,DI
mov BX,AX
